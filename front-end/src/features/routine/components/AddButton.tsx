...
export function AddButton({ title, classNameButton,classNameText,...props }: Props) {
    ...
    return (
        <button
            ...
            title="Add Item"
            className={cn(
                "flex-1 h-full w-full flex items-center justify-center border-edit/10 bg-none border-2 rounded-xl p-2 border-dashed cursor-pointer group hover:border-edit transition-all duration-300 ease-in-out hover:shadow-edit/10 shadow-aura",
                classNameButton
            )}
        >
